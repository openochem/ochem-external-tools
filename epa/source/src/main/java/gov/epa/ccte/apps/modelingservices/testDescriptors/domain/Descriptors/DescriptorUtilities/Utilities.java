...
//		}
   ...
   * @return
   */
  public static ArrayList<String> Parse3toArrayList(String Line, String Delimiter) {
...
//		  System.out.println(c);
  ...
  public static int GetColumnNumber(String var, List<String> l) {
  ...
  public static int FindFieldNumber(String Line, String field) {
    List<String> myList = Utilities.Parse(Line, "\t");
  ...
  public static int FindFieldNumber(String Line, String field,String del) {
	    List<String> myList = Utilities.Parse3(Line, del);
  ...
  public static void SetFonts(Container myContainer) {
    ...
    try {
      Font myFont = new Font("Arial", 0, 11);
      Font myFontBold = new Font("Arial", 1, 11);
...
//          System.out.println(Name);
  ...
  public static List <String>RetrieveFileList(String zipfilename) {
 ...
 public static List<String> RetrieveFilesWithString(List<String> l,
                                                    String matchstring,
                                                    int StartIndex) {
...
//	 String Line="\"581-12-4\",Chemidplus3DMolFile,350,\"2-Pentanone, 1-(5-(3-furyl)-2-methyl-tetrahydro-2-furyl)-4-methyl-,\"";
	 ...
	 List<String>l=Utilities.Parse3(Line, ",");
