...
import gov.epa.ccte.apps.modelingservices.testDescriptors.domain.Descriptors.DescriptorCalculations.*;
import gov.epa.ccte.apps.modelingservices.testDescriptors.domain.Descriptors.DescriptorUtilities.CDKUtilities;
...
//		}
	...
	public void Normalize(IAtomContainer m) {
		try {
			...
			InputStream ins = new FileInputStream(EPAServer.getFile("fixsmiles.xml"));
